...
public class ConexionPedido {
    ...
    public void runReporte(String porPedido) {
        //this.id_contact="";
        //this.id_contact = id;

        try {
            String master = System.getProperty("user.dir")
                    + "\\src\\produccion\\porpedido.jasper";
            ...
            parametro.put("pedido", porPedido);
