 ...
 * @author JP
 */
//Declaracion Clase ReporteNomina
public class ReporteNomina {

    //Metodo Generar ReporteNomina
    public void GenerarReporte() {
        ...
        try {
            ...
            JasperReport Report = JasperCompileManager.compileReport(System.getProperty("user.dir").concat("\\src\\report\\Nomina.jrxml"));
